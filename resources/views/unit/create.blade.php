...
<div class="container">
    ...
    <form action="{{ route('unit.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="no_cabang" class="form-control" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="bank_nomor" class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label>RT/RW</label>
            <input type="text" name="alamat_rt_rw" class="form-control">
        </div>
        <div class="mb-3">
            <label>Kode Pos</label>
            <input type="text" name="alamat_kode_pos" class="form-control">
        </div>
        <div class="mb-3">
            <label>Kel/Desa</label>
            <input type="text" name="alamat_kel_des" class="form-control">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="alamat_kota_kab" class="form-control">
        </div>
        <div class="mb-3">
